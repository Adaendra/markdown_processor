...
module.exports = function blockquote_processor(str) {
    ...
    if (arrayMatches != null) {
        arrayMatches = arrayMatches.map(match => {
            ...
            if (matchLines[0] == "> **[DND_CREATURE_STATS_BLOCK]**") {
                index = 1;
                supplementaryClass="dnd-stat-bloc dnd-creature"
            }

            if (matchLines[0] == "> **[DND_WEAPON_STATS_BLOCK]**") {
                index = 1;
                supplementaryClass="dnd-stat-bloc dnd-weapon"
            }
