...
class HtmlGenerator {
    ...
    // ----- Public Methods
    generateHtmlFile(fileName, filePath, fileContent, css_theme, custom_css_theme, is_pdf) {
        let htmlFileContent = this.constructHtmlFile(fileContent, fileName, css_theme, custom_css_theme, is_pdf)

        fs.writeFileSync(filePath, htmlFileContent, () => {})

    }

    constructHtmlFile(fileContent, title, css_theme, custom_css_theme, is_pdf) {
