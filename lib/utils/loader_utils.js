...
this.definition_processor = require('./../md_processors/definition_processor')
this.blockquote_processor = require('./../md_processors/blockquote_processor')
this.page_breaker_processor = require('./../md_processors/page_breaker_processor')
this.page_separator_processor = require('./../md_processors/page_separator_processor')


/**
 * Load processors functions from the config file.
